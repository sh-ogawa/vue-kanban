  ...
  describe('プロパティ', () => {
    describe('validation', () => {
      ...
      describe('email', () => {
        ...
        describe('format', () => {
          describe('メールアドレス形式ではない', () => {
            it('validation.email.formatがinvalidであること', () => {
              loginForm.setData({ email: 'foobar' })
              expect(loginForm.vm.validation.format.required).to.equal(false)
            })
          })
          describe('メールアドレス形式', () => {
    ...
    describe('disableLoginAction', () => {
      ...
      describe('バリデーション項目すべてＯＫでログイン処理中ではない', () => {
        it('ログイン処理は有効', () => {
          loginForm.setData({
            email: 'foobar@domain.com',
            password: '12345678'
      ...
      describe('バリデーション項目すべてＯＫでログイン処理中', () => {
        it('ログイン処理は無効', () => {
          loginForm.setData({
            email: 'foobar@domain.com',
            password: '12345678',
